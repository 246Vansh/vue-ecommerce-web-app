...
import {
  ...
  TabList,TabPanel,TabPanels,TransitionChild,
  TransitionRoot,
} from '@headlessui/vue'
import {
...
const footerNavigation = {
  ...
  account: [
    ...
    { name: 'Logout',action: handleLogout , href: '/login'}
  ],
  connect: [
  ...
  <div class="bg-white">
        ...
        <div class="fixed inset-0 z-40 flex">
          <TransitionChild as="template" enter="transition ease-in-out duration-300 transform" enter-from="-translate-x-full" enter-to="translate-x-0" leave="transition ease-in-out duration-300 transform" leave-from="translate-x-0" leave-to="-translate-x-full">
            <DialogPanel class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
              ...
              <div class="space-y-6 border-t border-gray-200 px-4 py-6">
                <div class="flow-root">
                  <button @click="handleSignup" class="-m-2 block p-2 font-medium text-gray-900">Create an account</button>
                </div>
                <div class="flow-root">
                  <button @click="handleLogin" class="-m-2 block p-2 font-medium text-gray-900">Log in</button>
                </div>
              </div>
    ...
    <div class="relative bg-gray-900">
            ...
            <div class="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
              ...
              <div class="flex items-center space-x-6">
                ...
                <div v-else class="space-x-6">
                  <button @click="handleLogin" class="text-sm font-medium text-white hover:text-gray-100">Log in</button>
                  <button @click="handleSignup" class="text-sm font-medium text-white hover:text-gray-100">Create an account</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
        ...
        <button @click="productPage" class="mt-8 inline-block rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100">Shop New Arrivals</button>
      </div>
    </div>
        ...
        <div class="py-20 xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="mt-12 md:mt-16 xl:mt-0">
            ...
            <form class="mt-2 flex sm:max-w-md">
              <input id="email-address" type="text" autocomplete="email" required="" aria-label="Email address" class="block w-full rounded-md bg-white px-4 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-white" />
